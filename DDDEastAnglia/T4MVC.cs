...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string Markdown_Converter_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/Markdown.Converter.min.js") ? Url("Markdown.Converter.min.js") : Url("Markdown.Converter.js");
                      
        public static readonly string Markdown_Editor_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/Markdown.Editor.min.js") ? Url("Markdown.Editor.min.js") : Url("Markdown.Editor.js");
