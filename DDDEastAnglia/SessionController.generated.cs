...
namespace DDDEastAnglia.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SessionController : DDDEastAnglia.Controllers.SessionController
    {
        ...
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, DDDEastAnglia.Models.Session session);

        public override System.Web.Mvc.ActionResult Create(DDDEastAnglia.Models.Session session)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "session", session);
            CreateOverride(callInfo, session);
            return callInfo;
        }
