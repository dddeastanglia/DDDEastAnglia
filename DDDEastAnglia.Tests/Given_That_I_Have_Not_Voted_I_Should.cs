...
{
    [TestFixture]
    public class Given_That_I_Have_Not_Voted_I_Should
    {
        private const int KnownSessionId = 1;
        private const int UnknownSessionId = 10;
        private static int[] SessionIdsVotedFor = new [] { KnownSessionId };
        private static int[] NoSessionIdsVotedFor = new int[0];
        ...
        [Test]
        public void Be_Able_To_Register_A_Vote_For_A_Session()
        {
        ...
        [Test]
        public void Correctly_Set_An_Empty_Cookie_When_Trying_To_Remove_A_Session()
        {
        ...
        [Test]
        public void Correctly_Set_An_Empty_Cookie_When_Trying_To_Add_An_Unknown_Session()
        {
        ...
        [Test]
        public void Correctly_Save_The_Vote_To_The_Database()
        {
            controller.RegisterVote(KnownSessionId);
