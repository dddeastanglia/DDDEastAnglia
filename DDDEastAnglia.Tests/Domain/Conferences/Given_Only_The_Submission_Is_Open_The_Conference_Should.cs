...
{
    [TestFixture]
    public class Given_Only_The_Submission_Is_Open_The_Conference_Should
    {
        [Test]
        public void Be_Open_For_Session_Submission()
        {
            Given_That_The_Conference_Has_No_CalendarEntries_Recorded();
            Then_The_Conference_Is_Open_To_Session_Submissions();
        }
        ...
        private void Given_That_The_Conference_Has_No_CalendarEntries_Recorded()
        {
            ...
            _conference.AddToCalendar(ConferenceHelper.GetFutureVotingPeriod());
            _conference.AddToCalendar(ConferenceHelper.GetOpenSubmissionPeriod());
        ...
        private void Then_The_Conference_Is_Open_To_Session_Submissions()
        {
            Assert.That(_conference.CanSubmit(), Is.True);
        }
